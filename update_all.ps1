<#
    ...
    .Description
        Uses Chocolatey AU to update packages in the specified folder (defaults to $PSScriptRoot\packages)
        It then pushes and reports on updated packages, based on the present configuration.
    .Example
        .\update_all.ps1
        # Attempts to update all packages in the default folder, \packages.
    .Example
